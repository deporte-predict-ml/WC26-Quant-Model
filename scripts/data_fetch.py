...
class DataFetcher:
    ...
    def __init__(self, api_key: str):
        ...
        # Nota: requests.Session().headers.update no usa headers=... en el .get() si ya están configurados
    ...
    def fetch_tournament_data(self, league: str, season: str) -> List[Dict]:
        ...
        while retry_count < max_retries:
            try:
                ...
                # Se eliminó headers=self.session.headers ya que Session los inyecta automáticamente
                ...
                # Corrección: uso seguro de e.response en lugar de la variable global response
    ...
    def validate_match(self, match: Dict) -> bool:
        ...
        Returns:
            True si es válido
        """
        # Corrección: 'season' suele venir dentro del dict 'league', no en la raíz.
        required_fields = [
            "fixture", "teams", "goals", "league"
        ]
        ...
        # Usamos .get() de forma segura por si "goals" no tiene "home" o "away"
        goals = match.get("goals", {})
        if goals.get("home") is None or goals.get("away") is None:
            return False
        
        # Validar fecha
        if "date" not in match.get("fixture", {}):
            return False
...
def main():
    ...
    if data["response"]:
        ...
        # Corrección: Retorna un código de error al SO para que GitHub Actions falle el job
        sys.exit(1)
